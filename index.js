  ...
  async fetch(request, env, ctx) {
    ...
    if (FAVICON_URL.includes(url.pathname)) {
      ...
      try {
        ...
        let pathname = new URL(env.request.url).pathname;
    ...
    // else do IP geolocation
      ...
      let html_style = `
          ...
          body{padding:6em; font-family: 'Source Sans 3', 'Source Sans Pro', sans-serif; color:white; margin:0 !important; height:100%; font-size: clamp(1rem, 0.96rem + 0.18vw, 1.125rem);}
          #container {
            display: flex;
      ...
      html_content += `<p> ASN: ` + clientASN + ` (<a href="https://radar.cloudflare.com/quality/as${clientASN}">Cloudflare Radar info</a>), ISP: ` + clientISP + `</p>`;
      html_content += "<p> Latitude: " + latitude + ", Longitude: " + longitude + "</p>";
      ...
      html_content += "<p> Region: " + request.cf.region + ", RegionCode: " + request.cf.regionCode + "</p>";
      ...
      let html = `<!DOCTYPE html>
        <head>
          ...
          <link rel="mask-icon" href="./favicon.svg" color="#fcfcfc">
